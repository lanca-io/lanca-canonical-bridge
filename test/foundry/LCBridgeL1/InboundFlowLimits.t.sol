...
contract InboundFlowLimitsTest is LCBridgeL1Test {
    ...
    function test_setInboundFlowLimit_Success() public {
        ...
        assertEq(availableVolume, MAX_FLOW_AMOUNT); // Start with max available amount
        ...
        (availableVolume, , , , ) = lancaCanonicalBridgeL1.getInboundFlowInfo(DST_CHAIN_SELECTOR);
    ...
    function test_inboundFlowLimit_TransferWithinLimit() public {
        ...
        (uint128 availableVolume, , , , ) = lancaCanonicalBridgeL1.getInboundFlowInfo(
            DST_CHAIN_SELECTOR
        );
        assertEq(availableVolume, MAX_FLOW_AMOUNT - 500 * 1e6); // 500 USDC available
    }
